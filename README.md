...
Git-native validation, evaluation, coverage analysis, and semantic diff for enterprise decision tables.
...
This repository focuses on the portable layer before runtime deployment: define the logic, validate it, prove coverage where possible, review changes, and then export or adapt it to the target platform.
...
See [the v1 specification](docs/specification.md) and [CI integration](docs/ci.md).

## Near-term roadmap

The next high-value layers are spreadsheet import, scenario files, stronger overlap analysis, generated Markdown/HTML views, DMN interoperability, and machine-readable change reports for agents and CI.
